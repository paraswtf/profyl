...
export default function HeroImage(props: Props = { height: 100 }) {
    ...
    return (
        <div className={classes.heroImage}>
            ...
            >
                <defs>
                    {/* <style>.cls1,.cls13{isolation:isolate;}.cls11,.cls12,.cls15,.cls2,.cls22,.cls9{fill:none;}.cls2{stroke:#3a4c5e;}.cls10,.cls11,.cls12,.cls14,.cls15,.cls16,.cls17,.cls18,.cls2,.cls22,.cls3,.cls4,.cls5,.cls9{stroke-linecap:round;stroke-linejoin:round;}.cls3,.cls8{fill:#999;}.cls10,.cls11,.cls14,.cls16,.cls17,.cls18,.cls3,.cls4,.cls5,.cls9{stroke:#263238;}.cls4,.cls7{fill:#b2b2b2;}.cls5,.cls6{fill:#263238;}.cls10,.cls19{fill:#e6e2c3;}.cls11,.cls18{stroke-width:0.5px;}.cls12{stroke:#666;}.cls13{opacity:0.3;}.cls14{fill:#a8a8a8;}.cls15{stroke:#b2b2b2;}.cls16,.cls18,.cls20{fill:#4084c5;}.cls17{fill:#88a47c;}.cls21{fill-opacity:0.8;fill:url(#linear-gradient);}.cls22{stroke:#fff;stroke-width:2px;}.cls23{fill:#350800;fill-opacity:0.15;}</style> */}
                    <linearGradient
                        id="linear-gradient"
                        x1="12"
                        y1="195.37"
                    ...
                    >
                        <stop offset="0" stop-color="#79addf" />
