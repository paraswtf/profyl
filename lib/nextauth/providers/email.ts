...
<body style="background: ${color.background}; padding-top: 50px; padding-bottom: 50px;">
  <table width="100%" border="0" cellspacing="20" cellpadding="0"
    style="background: ${color.mainBackground}; max-width: 600px; margin: auto; margin-top: 50px; margin-bottom: 50px; border-radius: 10px;">
    <!-- start logo -->
      <tr>
            ...
            <tr>
              <td align="center" valign="top" style="padding: 36px 24px;">
                <a href="${host}" target="_blank" style="display: inline-block;">
                  <img src="https://${host}/emaillogo.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                </a>
              </td>
            </tr>
          </table>
